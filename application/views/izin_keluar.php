    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Permohonan Izin Keluar</li>
                    </ol>
                </nav>
            </div>
        </div>
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">PERMOHONAN IZIN KELUAR</h6>
        <hr />
                    ...
                    <div class="card-body">
                        <div class="card-header text-end">
                            <button type="button" class="btn btn-outline-primary px-5" data-bs-toggle="modal"
                                ...
                                onclick="BukaModalKeluar('<?php echo base64_encode($this->encryption->encrypt(-1)); ?>')"><i
        ...
        <div class="modal fade" id="tambah-modal" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered">
                <form method="POST" id="formIzinKeluar" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="tgl_izin" class="form-label">Tanggal Izin </label><code>*</code>
                                    <input type="text" id="tgl_izin" name="tgl_izin" class="form-control"
                                        placeholder="Pilih Tanggal..." />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-6">
                                    <label for="jam_mulai" class="form-label">Jam Mulai </label><code>*</code>
                                    <input type="text" id="jam_mulai" name="jam_mulai" class="form-control timepicker"
                                        placeholder="Pilih Jam Mulai..." />
                                </div>
                                <div class="col-6">
                                    <label for="jam_selesai" class="form-label">Jam Selesai </label><code>*</code>
                                    <input type="text" class="form-control timepicker" id="jam_selesai"
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="alasan" class="form-label">Alasan Izin </label><code>*</code>
                                    <textarea id="alasan" class="form-control" rows="2" name="alasan"
                                        placeholder="Alasan Izin"></textarea>
                                </div>
                            </div>
