                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="mb-0 text-primary" id="jum_validasi_cuti_atasan"></h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="mb-0 text-success" id="jum_validasi_cuti_atasan_proses"></h4>
                                </div>
        ...
        <div class="row row-cols-12">
            <div class="col">
                <div class="card border-primary border-top border-3 border-0">
                    <div class="card-body">
                        <div class="card-body" id="tabelValidasiCutiAtasan">
                        </div>
                    </div>
                </div>
            </div>
