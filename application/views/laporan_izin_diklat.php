<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">LAPORAN IZIN DIKLAT</h6>
        <hr />
        ...
        <div id="hasilCariDiklat" class="row row-cols-12" style="display: none">
            <div class="col">
                <div class="card border-primary border-top border-3 border-0">
                    <div class="card-body">
                        <div class="card-body" id="tabelLaporanDiklat">
                        </div>
                    </div>
                </div>
            </div>
